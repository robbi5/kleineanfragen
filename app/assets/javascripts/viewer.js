...
// var DEFAULT_URL = 'compressed.tracemonkey-pldi-09.pdf'; // #kA
var DEFAULT_URL = PAPER_URL; // #kA
...
function configure(PDFJS) {
  // PDFJS.imageResourcesPath = './images/'; // #kA
  // PDFJS.workerSrc = '../build/pdf.worker.js'; // #kA
  // PDFJS.cMapUrl = '../web/cmaps/'; // #kA
  // PDFJS.cMapPacked = true; // #kA
}
...
var PDFViewerApplication = {
  ...
  initialize: function pdfViewInitialize(appConfig) {
    ...
    */
    ...
    // this.passwordPrompt = new PasswordPrompt(appConfig.passwordOverlay); // #kA
  ...
  cleanup: function pdfViewCleanup() {
    ...
    // this.pdfThumbnailViewer.cleanup(); // #kA
  ...
  rotatePages: function pdfViewRotatePages(delta) {
    ...
    // this.pdfThumbnailViewer.pagesRotation = this.pageRotation; // #kA
