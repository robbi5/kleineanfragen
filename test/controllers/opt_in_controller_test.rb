...
class OptInControllerTest < ActionController::TestCase
  test 'should get confirm' do
    ...
    get :confirm, params: { 'subscription' => sub.to_param, 'confirmation_token' => '8224d55d9cfeb211aa067a08f97a0e5fd6250195' }
  ...
  test 'should get report' do
    ...
    get :report, params: { 'subscription' => sub.to_param, 'confirmation_token' => '8224d55d9cfeb211aa067a08f97a0e5fd6250195' }
    assert_response :success
  end
  ...
  test 'should cancel active subscriptions on report' do
    ...
    get :report, params: { 'subscription' => sub.to_param, 'confirmation_token' => '24fb72b3195aa101b88ac05ecbee060cacc7739d' }
    assert_response :success
